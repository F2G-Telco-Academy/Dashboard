    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-medium text-sm text-primary dark:text-gray-100 tracking-tight">DriveTest</span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <Button size="sm" onClick={() => window.location.href = '#features'}>Get Started</Button>
        </div>
      ...
      <div className={cn(
        ...
        <nav className="p-4 space-y-1">
          ...
          <div className="pt-2 px-4">
            <Button size="sm" className="w-full" onClick={() => { setIsMobileMenuOpen(false); window.location.href = '#features'; }}>Get Started</Button>
          </div>
        </nav>
      </div>
    </header>
